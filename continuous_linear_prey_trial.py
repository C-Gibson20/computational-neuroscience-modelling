...
class PredatorTrialContinuous:
    ...
    def init_preys(self):
        ...
        for n in range(self.n_prey):
            ...
            self.inital_prey_locations.append(prey.location.copy())
    ...
    def run_training_trial(self):
        ...
        """
        training_trial_data = {'path': [self.agent.location], 'rewards': [], 'prey_locations': [self.inital_prey_locations], 'env': []}
        ...
        for time in range(self.n_steps):
            ...
            location, reward = self.agent.act(self.env, prey_locations, prey_speeds, visible, noise_scale=self.sensor_noise, training=True) 
    ...
    def run_trial(self):
        ...
        """
        test_trial_data = {'path': [self.agent.location], 'preys': [], 'prey_locations': [self.inital_prey_locations], 'env': []}
        ...
        for time in range(self.n_steps):
            ...
            location, _ = self.agent.act(self.env, prey_locations, prey_speeds, noise_scale=self.sensor_noise) 
